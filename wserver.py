...
<body>
  <!--© Designed and coded by @mhd_thanzeer-Telegram-->
    <header>
      <div class="brand">
        <img
      ...
      <div class="social">
        <a href="https://t.me/mhd_thanzeer"><i class="fab fa-github"></i></a>
        <a href="https://t.me/mhd_thanzeer"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
      <div class="intro">
    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/mhd_thanzeer">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
...
async def homepage(request):
    ...
    return web.Response(text="<h1>See mirror-leech-telegram-bot <a href='https://t.me/mhd_thanzeer'𝗠𝗛𝗗_𝗧𝗛𝗔𝗡𝗭𝗘𝗘𝗥</a> By <a href='https://t.me/mhd_thanzeer'>𝗠𝗛𝗗_𝗧𝗛𝗔𝗡𝗭𝗘𝗘𝗥</a></h1>", content_type="text/html")
