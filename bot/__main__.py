...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Help 🤧", "tg://settings")
    buttons.buildbutton("Contact ✨️", "https://t.me/mhd_thanzeer")
...
'''
        ...
        sendMarkup('<b>You Are Not Authorized User,</b>', context.bot, update, reply_markup)
